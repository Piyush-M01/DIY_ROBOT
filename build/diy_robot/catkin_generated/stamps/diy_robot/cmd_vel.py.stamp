...
class wheel_interface:
    ...
    def __init__(self):
        ...
        self.gpio.setup(self.motor1in1, gpio.OUT)
        self.gpio.setup(self.motor1in2, gpio.OUT)
        self.gpio.setup(self.motor2in1, gpio.OUT)
        self.gpio.setup(self.motor2in2, gpio.OUT)
    ...
    def forward(self,left, right):
        ...
        sleep(0.1)
        self.gpio.output(self.motor1in1, True)
        self.gpio.output(self.motor1in2, False)
        self.gpio.output(self.motor2in1, True)
        self.gpio.output(self.motor2in2, False)
    ...
    def reverse(self,left, right):
        ...
        self.motor2.ChangeDutyCycle(right)
        sleep(0.1)
        self.gpio.output(self.motor1in1, False)
        self.gpio.output(self.motor1in2, True)
        self.gpio.output(self.motor2in1, False)
        self.gpio.output(self.motor2in2, True)
